# Project 1: Esty Jewelry Market Analysis

This project contains code and analysis for exploring the Etsy jewelry market using shop‑level and listing‑level data from eRank.
It focuses on understanding what drives sales and revenue for top Etsy jewelry sellers and how new or existing shops can optimize their product and price.
